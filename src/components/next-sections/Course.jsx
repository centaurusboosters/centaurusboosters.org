    ...
    <div style={{ padding: '84px 6vw', background: '#0e1f47' }}>
      <div className="course-outer" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'center' }}>
        <div>
          ...
          <h2 style={{ fontFamily: "'Anton',sans-serif", fontSize: 50, color: '#fff', margin: '14px 0 0', lineHeight: 1 }}>{tournament.venue.toUpperCase()}</h2>
          <p style={{ color: '#aebbe0', fontSize: 17, lineHeight: 1.6, margin: '16px 0 22px', maxWidth: 480 }}>{tournament.course_description}<br /><br />{tournament.address}</p>
