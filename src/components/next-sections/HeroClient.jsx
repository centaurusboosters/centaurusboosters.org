  ...
  slides.push({
    ...
    node: (
      <>
        ...
        <div className="hero-cta">
          <a data-tina-field={tinaField(mission, 'cta_primary')} href="#getinvolved" className="btn btn--red btn--md btn--jump">{mission.cta_primary}</a>
          <a data-tina-field={tinaField(mission, 'cta_secondary')} href="#donate" className="btn btn--ghost btn--md btn--jump">{mission.cta_secondary}</a>
        </div>
      </>
    ),
  });
